...
public class own_adventure {
	...
	int option5 = JOptionPane.showOptionDialog(null, "Now returning along the same path you see something a wolf burrying something shiny in a whole. There is a shovel right there too. Do you want to dig for the key or return back along the same path.", null, 0, JOptionPane.INFORMATION_MESSAGE, null, 
	...
	static void keepGoing3() {
		JOptionPane.showMessageDialog(null, "You decide not to jump in the river but you heard something behind you, you tripped and fell and landed head first on the grounf causing you to die.");
		health -=100;
		keys += 0;
	}
	...
	static void returnBack() {
		JOptionPane.showMessageDialog(null, "You decide not get the key in between the rocks but as you begin to head back a wolf out of nowhere attacks you and pushes you into a sharp rock causing you to die.");
		health -= 100;
		keys += 0;
	}
	
	static void digKey() {
		JOptionPane.showMessageDialog(null, "You decide to go down and dig for the key, as you're digging you remember #1 Rule of Minecraft...never dig straight down..but this isn't Minecraft and you get the key. As you head back you trip into a tunnel and lose 9 health and at the end of the tunnel you get the final key you need which was hidden. ");
	health -= 9;
	keys += 2;
	...
	static void differentPath() {
		JOptionPane.showMessageDialog(null, "You decide not to dig down for the key and keep looking fo another key.");
		health -= 0;
		keys += 0;
	}
